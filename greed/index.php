	...
	<body>
		<div id="container" style="width:500px; margin:0 auto;">
			...
			<div id="learn" style="display:none;">
				...
				<p>Greed was designed to be a simple, intuitive game concept for mobile. This is my first attempt at a mobile app and I believe it has the potential to do very well.</p>
			</div>			
			...
			<div class="items" style="display:none;">
				...
				<ul style="float:left; width:40%; height:45%; background:lightgreen;">
				...
				<ul style="float:right; width:40%; height:45%; background:lightcoral;">
